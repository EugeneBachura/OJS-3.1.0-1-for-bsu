<?php return array (
  ...
  'manager.payment.authorFeesDescription' => 'Выбранные варианты, вместе с их описаниями и ценами (они могут быть изменены ниже), появятся на Шаге 1 процесса отправки материала и на странице «О журнале» в разделе «Отправка материалов», а также во всех местах, где требуется оплата.',
  ...
  'manager.payment.options.enablePayments' => 'Щелкните здесь, чтобы включить модуль «Платежи». Вам нужно сконфигурировать настройки платежей, заполнив форму ниже. Обратите внимание, что для осуществления платежей пользователи должны будут войти на сайт под своей учетной записью.',
  ...
  'manager.payment.options.waiverPolicy' => 'Правила отмены платежей',
  ...
  'manager.setup.masthead.description' => 'Список редакторов, управляющих директоров и других людей, связанных с журналом.',
  ...
  'manager.subscriptionPolicies.expiryReminderAfterMonths1' => 'Уведомить подписчиков по электронной почте через',
  'manager.subscriptionPolicies.expiryReminderAfterMonths2' => 'месяцев после окончания срока подписки.',
  ...
  'manager.subscriptionPolicies.expiryReminderBeforeMonths1' => 'Уведомить подписчиков по электронной почте за',
  'manager.subscriptionPolicies.expiryReminderBeforeMonths2' => 'месяцев до окончания срока подписки.',
  ...
  'manager.subscriptionPolicies.subscriptionPoliciesSaved' => 'Ваши настройки правил подписки были обновлены.',

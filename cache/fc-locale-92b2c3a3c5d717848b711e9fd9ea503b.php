...
<p>Система не сможет автоматически перезаписать файл конфигурации. Чтобы применить ваши измененные настройки конфигурации, вам нужно открыть <tt>config.inc.php</tt> в подходящем текстовом редакторе и заменить его содержимое содержимым текстового поля ниже.</p>',
  ...
  'plugins.categories.citationFormats.description' => 'Модули форматов ссылок предоставляют пользователям различные форматы, с помощью которых можно получить доступ к библиографическим ссылкам статей.',
...
<ol type="a">
  ...
  'manager.setup.citations.enable' => 'Включить Помощник разметки библиографических ссылок',
...
<li>Используйте <strong>*</strong> в качестве специального символа, заменяющего любую последовательность символов, например, <em>соц* мораль</em> найдет документы, содержащие «социальная» или «социологическая»</li>
  ...
  'about.editorialTeam' => 'Редакционная коллегия',
  ...
  'gifts.thankYouMessage' => 'Вы завершили покупку подарка. Вы получите копию письма с информацией о подарке, отправленной получателю подарка, как только ваш платеж будет обработан.',
  'gifts.purchaseGiftIndividualSubscription' => 'Подписка в подарок',
  'gifts.subscriptionFormIntroduction' => 'Пожалуйста, заполните форму ниже. Указанная Вами контактная информация вместе с личным сообщением получателю подарка будут использованы для отправки письма получателю подарка электронной почтой и информирования его о новой, подаренной подписке (вы также получите копию этого письма).',
...
<p>Если вы еще не зарегистрированы и хотите получать новости и обновления, <strong>пожалуйста, зарегистрируйтесь на <a href="http://pkp.sfu.ca/ojs/register" target="_new">http://pkp.sfu.ca/ojs/register</a>.</strong> Если у Вас есть вопросы или предложения, пожалуйста, посетите <a href="http://forum.pkp.sfu.ca" target="_new">форум поддержки</a>.</p>',
  ...
  'log.review.reviewCancelled' => '{$round}-й раунд рецензирования рецензентом {$reviewerName} для материала {$submissionId} был отменен.',
...
Проверка может оказываться неудачной на адресах сайтов для поиска, которые требуют заполнения формы поиска.',
  ...
  'notification.mailListDescription' => 'Введите ваш адрес электронной почты, чтобы моментально получать уведомления о добавлении нового контента в журнал.',
  'notification.notificationsPublicDescription' => 'На этой странице показан список важных обновлений, связанных с этим журналом, таких как выход новых выпусков или объявления. Вы можете подписаться на эти уведомления через ленты RSS (щелкнув на значках справа) или   <a href="{$emailUrl}">по электронной почте.</a>',
  ...
  'notification.type.assignProductionUser' => 'Назначить пользователя для создания гранок с помощью ссылки «Добавить» в списке «Участники».',

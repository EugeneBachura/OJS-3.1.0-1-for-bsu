<?php return array (
  ...
  'grid.user.mergeUsers.into.description' => 'Теперь вы должны выбрать пользователя, которому передать авторства предыдущего пользователя, редакционные задания и т. д.',
  'grid.user.mergeUsers.from.description' => 'Выбрать пользователя для объединения в другую учетную запись пользователя (например, когда у кого-то есть две учетных записи пользователя). Учетная запись, выбранная первой, будет удалена и все материалы, назначения и пр. будут переданы второй учетной записи.',
  'grid.user.mergeUsers.allUsers' => 'Все записанные пользователи',
  'grid.user.mergeUsers.mergeUserSelect.confirm' => 'Вы уверены, что хотите объединить этого пользователя с другим? Вы выберете пользователя на следующей странице.',
  ...
  'grid.user.mergeUsers.noneEnrolled' => 'Нет пользователей с этой ролью.',

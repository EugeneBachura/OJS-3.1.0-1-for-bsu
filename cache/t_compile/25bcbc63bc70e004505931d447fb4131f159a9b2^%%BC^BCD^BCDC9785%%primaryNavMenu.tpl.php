<?php /* Smarty version 2.6.25-dev, created on 2018-02-12 07:28:18
...
<ul id="navigationPrimary" class="pkp_navigation_primary pkp_nav_list">
	...
	<?php if ($this->_tpl_vars['currentJournal']): ?>
		...
		<li>
			<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('router' => @ROUTE_PAGE,'journal' => 'index'), $this);?>
">
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "navigation.allJournals"), $this);?>

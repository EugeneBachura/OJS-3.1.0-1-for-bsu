...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('authorName', ob_get_contents());ob_end_clean(); ?>
			...
			<?php endif; ?>
						...
						<?php if ($this->_tpl_vars['article']->getLocalizedCitations()): ?>
				<div class="item references">
					...
					<div class="value">
						<?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getLocalizedCitations())) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
unset($_smarty_tpl_vars);
 ?>
			...
			<?php if (count($this->_tpl_vars['keywords'])): ?>
				<div class="item published">
					<div class="label">
    ...
    foreach ($_from as $this->_tpl_vars['counter'] => $this->_tpl_vars['keyword']):
?>
						 	<?php if ($this->_tpl_vars['counter'] == count($this->_tpl_vars['keywords']) - 1): ?>

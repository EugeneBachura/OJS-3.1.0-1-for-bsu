<?php return array (
  ...
  'informationCenter.currentNotes' => 'Заметки к текущей версии',
  'informationCenter.pastNotes' => 'Заметки к предыдущим версиям',
  'informationCenter.lastUpdated' => 'Последнее обновление',
  ...
  'notification.email' => 'Не отправлять мне письмо по электронной почте для следующих типов уведомлений.',
  ...
  'notification.mailList.privacyProtection' => 'Правила защиты личной информации',
  ...
  'notification.subscribeSuccess' => 'На указанный Вами адрес электронной почты было отправлено письмо. Пожалуйста, щелкните на ссылке подтверждения в этом письме, чтобы добавить себя в список рассылки.',
  ...
  'notification.unsubscribeError' => 'При отмене Вашей подписки произошла ошибка. Пожалуйста, убедитесь, что вы используете правильный URL-адрес как указано в уведомлении, пришедшем на Ваш адрес электронной почты.',
  ...
  'notification.addedReviewer' => 'Рецензент добавлен.',
  ...
  'notification.type.assignCopyeditors' => 'Назначьте литературного редактора, используя ссылку «Добавить» в списке «Участники».',

<?php return array (
  ...
  'plugins.generic.tinymce.description' => 'Включает визуальное редактирование (WYSIWYG) текстовых областей с использованием редактора контента <a href="http://tinymce.moxiecode.com" target="_blank">TinyMCE</a>.',
